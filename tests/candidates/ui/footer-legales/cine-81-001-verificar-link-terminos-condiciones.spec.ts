...
test(
    "CINE-81 · Verificar link 'Términos y condiciones generales' con target _blank y PDF correcto",
    {
    ...
    async ({ page, footerComponent }) => {
        ...
        await test.step("Hacer click en 'Términos y condiciones'", async () => {
            ...
            expect(downloadUrl).toBe(
                "https://pimcore-content.cinepolis.com/assets/Legales/terminos-condiciones-cinepolis.pdf"
            );
        });
    }
);
